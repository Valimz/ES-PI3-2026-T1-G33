...
router.post('/createOffer', requireAuth, async (req, res) => {
    try {
        const user = req.user;
...
router.post('/makeCounterOffer', requireAuth, async (req, res) => {
    try {
        const user = req.user;
...
router.post('/acceptOffer', requireAuth, async (req, res) => {
    try {
        const user = req.user;
        ...
        await db.runTransaction(async (transaction) => {
            ...
            if (buyerBalance < price)
                throw new Error("Saldo insuficiente do comprador");

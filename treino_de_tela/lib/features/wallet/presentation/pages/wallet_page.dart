...
import 'package:treino_de_tela/features/wallet/presentation/pages/transaction_details_page.dart';
            ...
            onPressed: () async {
              ...
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text(
                          "Ativos fictícios (sem histórico real) foram limpos!")),
                );
              }
            },
          ),
                        ...
                        try {
                          ...
                          if (context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text(
                                    "Todos os tokens de ${asset['name']} vendidos com sucesso!")));
                          }
                        } catch (e) {
                          if (context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
            ...
            return InkWell(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        TransactionDetailsPage(transaction: acq),
                  ),
                );
              },
              child: Container(
